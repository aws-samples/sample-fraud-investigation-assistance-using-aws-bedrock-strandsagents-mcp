...
# Bucket resource
#
# nosemgrep: aws-s3-bucket-versioning-not-enabled   # Versioning acceptable backup for prototype
resource "aws_s3_bucket" "bucket" {
  #Skipping checkov checks
  #checkov:skip=CKV_AWS_144: no s3 cross region replication
  #checkov:skip=CKV2_AWS_61: "Ensure that an S3 bucket has a lifecycle configuration"
  #checkov:skip=CKV2_AWS_62: "Ensure S3 buckets do not need notifications enabled for prototype"
...
resource "aws_s3_bucket_server_side_encryption_configuration" "sse_conf" {
  #checkov:skip=CKV2_AWS_67: "S3 buckets with service managed SSE is sufficient and CMK keys with rotation not necessry for prototype"
